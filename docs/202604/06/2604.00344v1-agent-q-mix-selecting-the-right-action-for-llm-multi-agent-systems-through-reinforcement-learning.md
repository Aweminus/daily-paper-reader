...
tldr: 针对大语言模型多智能体系统中拓扑结构选择和智能体互联的难题，本文提出 Agent Q-Mix 框架。该方法将拓扑选择建模为协作式多智能体强化学习（MARL）问题，利用 QMIX 价值分解实现去中心化的通信决策。通过结合 GNN 编码器和 CTDE 范式，Agent Q-Mix 在平衡任务准确率与 Token 成本的同时，在多个基准测试中显著超越了现有框架，展现了极高的效率和鲁棒性。
selection_source: fresh_fetch
motivation: 旨在解决多智能体系统中如何有效选择和连接智能体以协同完成复杂任务的挑战。
method: 将拓扑选择重构为多智能体强化学习问题，采用 QMIX 价值分解、GNN 编码器和 CTDE 范式来学习去中心化的通信决策。
result: "在 7 个核心基准测试中取得最高平均准确率，并在 HLE 挑战中以 20.8% 的成绩优于 Microsoft Agent Framework 和 LangGraph 等主流框架。"
conclusion: 实验证明，通过强化学习实现的去中心化拓扑优化能显著提升多智能体系统的推理能力、Token 效率和系统鲁棒性。
---
