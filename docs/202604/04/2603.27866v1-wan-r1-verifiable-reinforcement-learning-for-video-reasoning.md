...
tldr: "本文针对视频生成模型在空间推理和多步规划方面的局限，提出了Wan-R1框架。研究发现传统多模态奖励模型在视频推理强化学习中易失效，因此通过将GRPO算法应用于流匹配视频模型，并设计了基于客观任务指标的可验证奖励函数（如迷宫轨迹和导航嵌入）。实验表明，该方法在3D迷宫和机器人避障任务中分别比SFT基准提升了29.1%和51.4%的准确率，证明了可验证奖励对提升视频推理鲁棒性的核心作用。"
selection_source: fresh_fetch
motivation: 视频生成模型在处理需要空间推理和多步规划的任务时表现欠缺，且现有的多模态奖励模型在强化学习训练中容易导致性能退化。
method: 将GRPO算法适配至流匹配视频模型，并针对迷宫和机器人导航任务设计了基于客观指标的可验证奖励函数。
result: "在复杂3D迷宫任务中准确率比SFT基准提升了29.1%，在避障任务中提升了51.4%，显著增强了模型的泛化能力。"
conclusion: 可验证奖励设计是实现稳定且鲁棒的视频推理强化学习的关键，能够有效避免多模态奖励模型带来的训练不稳定问题。
---
