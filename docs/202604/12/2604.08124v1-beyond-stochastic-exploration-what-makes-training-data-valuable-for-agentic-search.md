...
tags: ["query:vlm-rl"]
score: 7.0
evidence: 基于强化学习的搜索智能体以提升推理能力
tldr: 针对当前基于强化学习的搜索智能体依赖随机探索导致效率低下和训练不稳定的问题，本文提出了HiExp框架。该框架通过对比分析和多级聚类从原始轨迹中提取层次化经验知识，并利用经验对齐训练将随机探索转化为经验驱动的策略搜索。实验证明，该方法在复杂搜索和数学推理任务中显著提升了性能，并具有极强的泛化能力。
